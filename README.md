...
|-----------|------------------------|-----------|-------------|----------|----|
| ![lang](https://skillicons.dev/icons?i=java,python,php,html&theme=light)![lang](https://skillicons.dev/icons?i=javascript,css,scss,&theme=light) | ![lang](https://skillicons.dev/icons?i=react,selenium,gherkin,bootstrap&theme=light) ![empty](https://skillicons.dev/icons?i=,,,&theme=light) | ![bds](https://skillicons.dev/icons?i=mysql,mongo,,&theme=light) ![empty](https://skillicons.dev/icons?i=,,,&theme=light) | ![web_servers_services](https://skillicons.dev/icons?i=aws,docker,nginx&theme=light)<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apache/apache-original.svg" width="28" height="28"  alt="apache"/> | ![apps_sft_tools](https://skillicons.dev/icons?i=postman,git,github,wordpress&theme=light) ![apps_sft_tools](https://skillicons.dev/icons?i=photoshop,illustrator,,&theme=light) | ![ides](https://skillicons.dev/icons?i=vscode,eclipse,,&theme=light) ![empty](https://skillicons.dev/icons?i=,,,,&theme=light) |
